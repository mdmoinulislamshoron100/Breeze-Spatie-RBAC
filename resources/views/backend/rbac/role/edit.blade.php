    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title">Role Edit</div>
                <div class="ms-auto">
                    <div class="btn-group">
                        ...
                        <form action="{{route('roles.update', $role->id)}}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', $role->name) }}" placeholder="Enter role name" autocomplete="name">
                                    @error('name')
                            ...
                            <div class="row align-items-center mb-3 border p-2 rounded">
                                <div class="col-md-3 d-flex align-items-center">
                                    ...
                                    {{ count($permissions->flatten()) === count($hasPermessions) ? 'checked' : ''}}>
                                    ...
                                    <div class="row align-items-start mb-3 border p-2 rounded permission-group">
                                        ...
                                        <div class="col-md-3 d-flex align-items-center">
                                            <input type="checkbox"
                                                ...
                                                {{ $groupPermissions->every(function($permission) use ($hasPermessions){
                                                    return in_array($permission->name, $hasPermessions);
                                                }) ? 'checked' : ''}}>
                                            ...
                                            @foreach ($groupPermissions as $permission)
                                                <div class="col-md-4 d-flex align-items-center mb-1">
                                                    <input type="checkbox"
                                                            ...
                                                            {{ in_array($permission->name, old('permissions', $hasPermessions)) ? 'checked' : '' }}>
