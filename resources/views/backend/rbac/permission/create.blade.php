    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title">New Permission Create</div>
                <div class="ms-auto">
                    <div class="btn-group">
                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        ...
                        <form action="{{route('permissions.store')}}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <label for="group" class="col-sm-3 col-form-label">Permission Group Name : </label>
                                <div class="col-sm-9">
                                    <div class="mb-2">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name') }}" placeholder="Enter permission name" autocomplete="name">
                                    @error('name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
